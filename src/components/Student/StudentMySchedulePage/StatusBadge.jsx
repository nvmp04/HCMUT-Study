...
const getStatusInfo = (status) => {
  switch(status) {
    case 'rejected': return { text: 'Tutor từ chối', color: 'text-red-600', bg: 'bg-red-50' };
    case 'cancelled_before_start': return { text: 'Đã hủy', color: 'text-orange-600', bg: 'bg-orange-50' };
    case 'expired_pending': return { text: 'Quá hạn chưa xác nhận', color: 'text-amber-700', bg: 'bg-amber-50' };
    case 'confirmed': return { text: 'Đã xác nhận', color: 'text-emerald-700', bg: 'bg-emerald-50' };
