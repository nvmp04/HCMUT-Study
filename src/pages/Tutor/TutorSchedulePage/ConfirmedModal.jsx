...
export default function ConfirmedModal({ slot, onClose }) {
  ...
  function handleCancel() {
    ...
    if (formatted === slot.appointment.date) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      {!showCancelModal && <div className="bg-white rounded-2xl p-6 max-w-md w-[92%] relative shadow-lg">
        ...
        <div className="mb-4 bg-gray-50 p-3 rounded-md border border-gray-100 text-sm">
          ...
          <p className="mt-2">
            <strong>Thời gian:</strong> {slot.appointment.date} — {slot.appointment.time}
          </p>
        </div>
